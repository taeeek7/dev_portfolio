...
SHEET_ID = '1OLg0vCdVasRAEb-woUKsWqzH0_oohxXxDSl6zLpH_qc'
FORMAT_SHEET_NAME = '긴급티켓발행양식'
UPLOAD_SHEET_NAME = 'python_upload'
SLACK_CHANNEL = 'C06FQURRGCS'
...
with DAG(
    dag_id="insert_ticket_format", # dag_id - 보통 파일명과 동일하게 
    schedule= None, # cron 스케줄
    start_date=pendulum.datetime(2024, 11, 5, 0, 0, tz="Asia/Seoul"), # 이전 스케줄 실행 date와 일치시키자
    ...
    task_format1 = PythonOperator(
        task_id='task_format1',
